...
class TradingEnvironment(Env):
    ...
    def _calculate_reward(self, action, prev_portfolio_value, fee_paid_this_step):
        ...
        # logger.debug(f"TRADE_PENALTY_CHECK: self.trade_penalty_weight = {self.trade_penalty_weight}") # REMOVED
        # ADD A DIRECT PRINT STATEMENT INSTEAD
        print(f"@@@ TRADE_PENALTY_WEIGHT_VALUE: {self.trade_penalty_weight} @@@") 

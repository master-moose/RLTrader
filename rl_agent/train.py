...
from stable_baselines3.sac.policies import SacMlpPolicy # Re-added for SAC model type
...
def create_model(
    ...
    if model_type == "dqn" or model_type == "lstm_dqn":
        ...
        model_kwargs.update({
            # "policy": SacMlpPolicy, # TEMP: Use standard MLP policy for testing SAC slowdown -> Reverted back to SacMlpPolicy
            "policy": TcnSacPolicy, # Reverted back to TcnSacPolicy
            "learning_rate": lr_schedule,
